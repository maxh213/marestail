...
HELP_EFFORT = "reasoning effort (claude and agy: low|medium|high|xhigh|max; grok and hermes: reasoning effort; kilo: variant; junie: low|medium|high); stamped on every commit"
